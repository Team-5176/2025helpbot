...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    rollerSubsystem.setDefaultCommand(new RollerCommand(
        ...
        rollerSubsystem));
    operatorController.y().onTrue(setArmPoseLowGoal);
    operatorController.y().onFalse(setArmPoseZero);
    operatorController.x().onTrue(setArmPoseHighGoal);
    operatorController.x().onFalse(setArmPoseZero);
  }
